...
test('sprints lifecycle', () => {
  const repository = new SprintsRepository();
  const created = repository.create({ name: 'Example', projectId: 'value', startDate: 'value', velocity: 1, active: true });
