...
test('boards lifecycle', () => {
  const repository = new BoardsRepository();
  const created = repository.create({ name: 'Example', projectId: 'value', description: 'value', position: 1, active: true });
